(function () {
  ...
  const publicForms = document.querySelectorAll('.js-formspree');
  ...
  // Formulaires publics : envoi vers Formspree si formEndpoint est configuré
  publicForms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      function unlockWithLabel(label) {
        ...
        fetch(endpoint, {
          ...
          .then(function (r) {
            if (r.ok) {
              ...
              unlockWithLabel('Erreur, réessayez');
            }
          })
          .catch(function () {
            unlockWithLabel('Erreur, réessayez');
