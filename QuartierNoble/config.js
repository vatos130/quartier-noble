...
Pour toute question d’interprétation, contactez Quartier Noble avant d’engager une action pouvant affecter une mission ou un contrat.`
  ...
  models: [
    ...
    },
    {
      ...
      label: "Femme",
      photos: [
        "model/anouch/anouch1.jpeg",
        "model/anouch/anouch.jpeg"
      ]
    },
    {
      name: "Yousra",
    ...
    },
    {
      ...
      label: "homme",
      photos: [
        "model/harysson/harysson3.jpeg",
        "model/harysson/harysson.jpeg",
        "model/harysson/harysson1.jpeg",
        "model/harysson/harysson2.jpeg"
      ]
    }
  ],
  ...
  locale: {
    ...
    postuler: {
      label: "Postuler",
      title: "Candidature mannequin",
      intro: "Remplissez ce formulaire avec vos informations. Notre équipe vous recontacte après étude du profil.",
      hint: "Joignez dans votre message vos liens Instagram/TikTok et toute expérience utile.",
      ...
      formCity: "Ville",
      formHeight: "Taille (cm)",
      formSocial: "Instagram / TikTok",
      formMessage: "Présentation",
